...
export function ClonePopup() {
  ...
  useEffect(() => {
    if (!comunicacionOriginal) {
      showError('No se puede clonar: el pop-up original no existe');
  ...
  const handleSaveDraft = () => {
    ...
    const comunicacion = {
      ...
      contenido: 'Pop-up',
      cuerpo: '',
      tipo: 'Local' as const, // Siempre Local en clonación
  ...
  const confirmPublish = () => {
    ...
    addComunicacion(comunicacion);
    showSuccess('¡Pop-up clonado con éxito!');
    navigate(`/programa/${programId}/comunicaciones/muro`);
  };
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="bg-white px-8 pt-10 pb-6 border-b border-gray-200">
            ...
            <h1 className="text-2xl font-medium">Clonar Pop-up</h1>
          </div>
