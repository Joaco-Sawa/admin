...
export function CloneComunicacionTransversal() {
  ...
  // Cargar datos de la comunicación original para clonar
  useEffect(() => {
    // Simular carga de datos con prefijo "Copia de"
    setTitulo('Copia de - Ejemplo de noticia');
    editor?.commands.setContent('<p>Este es el contenido de la comunicación que se está clonando.</p>');
  }, [editor]);
  ...
  const confirmPublish = () => {
    showSuccess(`¡${tipo} transversal clonada con éxito!`);
    navigate('/comunicaciones-transversales/muro');
  };
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="bg-white px-8 pt-10 pb-6 border-b border-gray-200">
            ...
            <h1 className="text-2xl font-medium">Clonar {tipo} Transversal</h1>
          </div>
        ...
        <div className="p-8 bg-[#F5F5F5]">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <p className="text-gray-600">
              Contenido del formulario de clonación (idéntico a crear, con datos precargados de la comunicación original)
            </p>
          </div>
